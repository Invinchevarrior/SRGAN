...
if __name__ == '__main__':
    ...
    plt.plot(epochs, results['psnr'])
    plt.xlabel('Epoch')  # 设置横轴标签
    plt.ylabel('PSNR')  # 设置纵轴标签
    plt.title('PSNR vs Epoch')  # 设置图标题
    plt.xticks(np.arange(0, 101, step=2))  # 设置横轴刻度为1到100，间隔为10
    plt.show()  # 显示图形
    plt.plot(epochs, results['ssim'])
    plt.xlabel('Epoch')  # 设置横轴标签
    plt.ylabel('SSIM')  # 设置纵轴标签
    plt.title('SSIM vs Epoch')  # 设置图标题
    plt.xticks(np.arange(0, 101, step=2))  # 设置横轴刻度为1到100，间隔为10
    plt.show()  # 显示图形